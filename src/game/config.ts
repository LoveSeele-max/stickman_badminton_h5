...
export const aiConfig = {
  normal: {
    ...
    jumpMinHeight: 230,
    jumpVyMin: -650,
    misreadThreshold: 0.76,
    mistakeOffset: 118,
    pressureLine: 500,
    pressureStep: 12,
    predictionFrames: 330,
    predictionStep: 1 / 90,
    racketOffset: 96,
    ...
    stopDistance: 18,
    targetError: 72,
    timingMistakeMaxHeight: 210,
    timingMistakeThreshold: 0.9,
  },
  boss: {
    assistForwardPad: 18,
    assistHeightPad: 14,
    ...
    jumpMinHeight: 190,
    jumpVyMin: -900,
    misreadThreshold: 0.985,
    mistakeOffset: 42,
    pressureLine: 560,
    pressureStep: 28,
    predictionFrames: 420,
    predictionStep: 1 / 120,
    racketOffset: 104,
    reactionInterval: 0.1,
    serveDelay: 0.55,
    stopDistance: 10,
    targetError: 18,
    timingMistakeMaxHeight: 150,
    timingMistakeThreshold: 0.985,
  },
};
